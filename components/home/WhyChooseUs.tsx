      ...
      <div className="max-w-7xl mx-auto px-4 py-24">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="w-12 h-[2px] bg-red-500 mb-6"></div>
          ...
          <div className="relative">
            {/* Image wrapper for spacing + polish */}
            <div className="relative h-[460px] w-full rounded-xl overflow-hidden shadow-xl">
              <Image
                src="/Expertise.webp"
